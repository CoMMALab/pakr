...
def visualize_trajectory_1(trajectory, output_name="./trajectory_final1.html"):
    """
...
def visualize_trajectory_2(trajectory, output_name="./trajectory_final2.html"):
    """
    trajectory: (N, 10) array
    State: [ee_x, ee_y, block_x, block_y, block_theta, ee_dx, ee_dy, block_dx, block_dy, block_dtheta]
    """
...
def visualize_trajectory_3(trajectory, output_name="./trajectory_final3.html"):
    """
    trajectory: (N, 10) array
    State: [ee_x, ee_y, block_x, block_y, block_theta, ee_dx, ee_dy, block_dx, block_dy, block_dtheta]
    """
...
def visualize_trajectory_4(trajectory, output_name="./trajectory_final4.html"):
    """
    trajectory: (N, 10) array
    State: [ee_x, ee_y, block_x, block_y, block_theta, ee_dx, ee_dy, block_dx, block_dy, block_dtheta]
    """
