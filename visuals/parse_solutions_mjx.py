...
# 2. Load Planner Data
actions = jnp.array(np.load("visuals/solution_actions1.npy"))
initial_state_arr = np.load("visuals/solution_states1.npy")[0]
...
# Save to disk
np.save("visuals/mjx_full_trajectory1.npy", np.array(flattened_trajectory))
print(f"Saved {len(flattened_trajectory)} states to mjx_full_trajectory1.npy")