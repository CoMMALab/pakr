...
TIERS = [64, 256, 1024, 4096, 16384, 32768, 70000]
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        # Solve
        tree, key, goal_mask, goal, states, start_idx, iter_val, size = jit_while(tree, sst_params, sim_params, callables, obstacles, i)
