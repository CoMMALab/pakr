...
if __name__ == "__main__":
    ...
    sst_params = SSTparams(
        ...
        goal_radius=0.25, time_to_evolve=43,
    )
    ...
    print(f"Starting {100} runs of Acrobot Swing-Up...")
    ...
    for i in range(100):
        ...
        # Ensure goal_found is checked to avoid calculating stats on failed runs
        ...
        if goal_found > 0:
            ...
            # Identify the specific node that reached the goal to get its cost
            ...
            print(f"Run {i:02d}: Failed to find solution within MAX_TREE_SIZE")
